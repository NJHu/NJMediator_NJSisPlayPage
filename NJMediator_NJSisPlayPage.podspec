#
# Be sure to run `pod lib lint NJMediator_NJSisPlayPage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NJMediator_NJSisPlayPage.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'NJMediator_NJSisPlayPage' => ['NJMediator_NJSisPlayPage/Assets/*.png']
  # }
